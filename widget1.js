// dhoscript.js - robust widget med Shadow DOM
(function() {
    if (window.dhoscriptWidgetLoaded) return;
    window.dhoscriptWidgetLoaded = true;

    function initWidget() {
        console.log("Widget initialiseres med Shadow DOM");

        // Find eller opret placeholder
        let hostElement = document.getElementById("dhoscript-widget");
        if (!hostElement) {
            hostElement = document.createElement("div");
            hostElement.id = "dhoscript-widget";
